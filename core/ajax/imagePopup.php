<?php 
    ...
    if(isset($_POST['showImage']) && !empty($_POST['showImage'])){
        ...
        $tweet = $getFromTweetClass->getPopupTweet($tweet_id);
        $likes = $getFromTweetClass->likes($user_id,$tweet_id);
        $retweet = $getFromTweetClass->checkRetweet($tweet_id, $user_id);
        ?>
        <div class="img-popup">
<div class="wrap6">
<span class="colose">
	...
	<div class="img-popup-footer">
		...
		<div class="img-popup-tweet-menu">
			<div class="img-popup-tweet-menu-inner">
			  	<ul> <?php if($getFromUserClass->loggedIn()=== true){
